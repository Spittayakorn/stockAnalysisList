            ...
            if (status == 'success') {
                ...
                if (data.length > 0) {
                    for (var j = 0, i = 1; j < data.length; j++, i++) {
                        ...
                        text += "<tr style='background-color:" + rowColor + ";color:" + color + ";'><td>" + i + "</td><td>" + data[j].itemName + "</td><td><div id='checkRow' class='" + j + "'><input type='number' max='9999999' step='0.01' id='take" + j + "' class='take' name='take[]' style='background-color:" + rowColor + ";color:" + color + ";' value='" + toFixed(data[j].take).toFixed(2) + "' readonly></div></td><td style='background-color:white;'><div id='checkRow' class='" + j + "'><input type='number' id='exist" + j + "' class='exist' name='exist[]' style='background-color:white;color:black;' value='" + toFixed(data[j].exist).toFixed(2) + "' readonly ></div></td><td><div id='checkRow' class='" + j + "'><input type='number' max='9999999' step='0.01' id='used" + j + "' class='used' name='used[]' style='background-color:" + rowColor + ";color:" + color + ";' value='" + toFixed(data[j].used).toFixed(2) + "' readonly></div></td><td style='background-color:white;'><div id='checkRow' class='" + j + "'><input type='number' id='lefted" + j + "' class='lefted' name='lefted[]' style='background-color:white;color:black;' value='" + toFixed(data[j].lefted).toFixed(2) + "' readonly></div></td><td><input type='number' max='9999999' step='0.01' id='added" + j + "' class='added' name='added[]' style='background-color:" + rowColor + ";color:" + color + ";' value='" + toFixed(data[j].added).toFixed(2) + "' readonly></td><input type='hidden' name='itemN[]' value='" + data[j].itemN + "'></tr>";

                    }
                } else {
                    text += "<tr><td colspan='7' style='color:green;'>กรุณาเพิ่มข้อมูลสินค้า</td></tr>";
                }
                ...
                if (status == 'success') {
                    ...
                    if (data.length > 0) {
                        for (var j = 0, i = 1; j < data.length; j++, i++) {
                            ...
                            text += "<tr style='background-color:" + rowColor + ";color:" + color + ";'><td>" + i + "</td><td>" + data[j].itemName + "</td><td><div id='checkRow' class='" + j + "'><input type='number' max='9999999' step='0.01' id='take" + j + "' class='take' name='take[]' style='background-color:" + rowColor + ";color:" + color + ";' value='" + data[j].take + "' readonly></div></td><td style='background-color:white;'><div id='checkRow' class='" + j + "'><input type='number' id='exist" + j + "' class='exist' name='exist[]' style='background-color:white;color:black;' value='" + toFixed(data[j].exist) + "' readonly ></div></td><td><div id='checkRow' class='" + j + "'><input type='number' max='9999999' step='0.01' id='used" + j + "' class='used' name='used[]' style='background-color:" + rowColor + ";color:" + color + ";' value='" + data[j].used + "' readonly></div></td><td style='background-color:white;'><div id='checkRow' class='" + j + "'><input type='number' id='lefted" + j + "' class='lefted' name='lefted[]' style='background-color:white;color:black;' value='" + toFixed(data[j].lefted) + "' readonly></div></td><td><input type='number' max='9999999' step='0.01' id='added" + j + "' class='added' name='added[]' style='background-color:" + rowColor + ";color:" + color + ";' value='" + data[j].added + "' readonly></td><input type='hidden' name='itemN[]' value='" + data[j].itemN + "'></tr>";
    ...
    <div class="container">
        ...
        <form action="addStockQuery.php" method="POST">
            <div class="content">
                ...
                <table id='tb'>
                    <thead>
                        ...
                        <tr>
                            ...
                            <th width='60%' colspan="5">วันที่&nbsp;&nbsp;<input type="datetime-local" step='1' id='showDate' name='stockDate' <?php echo "value=$replaceStockDate"; ?> readonly></th>
                        </tr>
                        <tr>
                ...
                <?php
                /*
                    echo "<div class='btn-addStock'>
                            <input type='submit' value='เพิ่มสต๊อก'>
                        </div>";
                    */
                ?>
            </div>
